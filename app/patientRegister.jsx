...
export default function PatientRegister() {
  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      console.log(
        "[patientRegister] Verificar paciente - verifyErr:",
        verifyErr
      );
      console.log(
        "[patientRegister] Verificar paciente - data:",
        verifyPatient
      );
      ...
      console.log(
        "[patientRegister] Actualizando paciente ID:",
        verifyPatient.id
      );
      ...
      if (updateErr) {
        console.error(
          "[patientRegister] Error al actualizar:",
          updateErr.message || updateErr
        );
        console.error("[patientRegister] Error code:", updateErr.code);
        console.error(
          "[patientRegister] Error details:",
